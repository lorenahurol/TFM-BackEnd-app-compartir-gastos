...
const checkBelongsToGroup = async (req, res, next) => {
  ...
  const [result] = await Group.userBelongsToGroup(req.params.groupId, req.user.id);
...
module.exports = { checkToken, checkBelongsToGroup, checkIsAdmin, checkIsAdminIdExpense };
